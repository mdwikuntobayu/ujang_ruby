...
describe User do
  ...
  describe "password validations" do
  	it "should require a password" do
  		user_passconf = User.new(@attr.merge(:password => "", :password_confirmation => ""))
  		user_passconf.should_not be_valid
  	end
  	
  	it "should require a matching password confirmation" do
  		User.new(@attr.merge(:password_confirmation => "invalid, password tidak sama"))
  	end
